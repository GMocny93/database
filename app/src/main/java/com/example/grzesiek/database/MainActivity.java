...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        db.addInformation(new information("Grzesiek", 184, 121.8 , 100.0, 25 ));
        ...
        for (information inf : information) {
            String log = "id: " + inf.getId() + ", name: " + inf.getName() + ", height"
                    ...
                    + inf.getTargetWeight() + ", age: " + inf.getAge();
            Log.d("Data", log);
            newTxt. setText("Witaj " + inf.getName() + "! Przy swoim wzroscie roznwym " + inf.getHeight() + " w wieku " + inf.getAge() + " ważysz " + inf.getWeight() + ". Jednak Twoim celem jest waga rowna " + inf.getTargetWeight() + ".");
        }
    }
}
